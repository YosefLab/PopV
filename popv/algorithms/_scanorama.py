...
class SCANORAMA:
    ...
    def compute_embedding(self, adata, embedding_key='X_scanorama_umap_popv'):
        logging.info('Saving UMAP of scanorama results to adata.obs["{}"]'.format(embedding_key))

        sc.pp.neighbors(adata, use_rep="X_scanorama")
        adata.obsm[embedding_key] = sc.tl.umap(adata, copy=True, **self.embedding_dict).obsm['X_umap']
